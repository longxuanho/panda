...
import template from './calendarsList.html';

import { name as CalendarsListUtilsBar } from '../calendarsListUtilsBar/calendarsListUtilsBar';
...
const name = 'calendarsList';

// create a module
export default angular.module(name, [
    angularMeteor,
    uiRouter,
    CalendarsListUtilsBar,
    CurrentUserService,
...
function config($stateProvider) {
    ...
    $stateProvider.state('calendarsList', {
