...
import { name as UserDetailsViewThietLapTabLogOutOtherClientsBtn } from '../userDetailsViewThietLapTabLogOutOtherClientsBtn/userDetailsViewThietLapTabLogOutOtherClientsBtn';
...
export default angular.module(name, [
    ...
    UserDetailsViewThietLapTabLogOutOtherClientsBtn
]).component(name, {
    template,
    controllerAs: name,
